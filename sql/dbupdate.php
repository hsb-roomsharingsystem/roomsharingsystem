...
$ilDB->manipulateF("INSERT INTO rep_robj_xrs_rattr (id, name, pool_id) VALUES (%s, %s, %s)", array("integer","text","integer"), array($resultTageslichtprojektorID,"Tageslichprojektor",$resultPoolID));
