...
class ilObjRoomSharingGUI extends ilObjectPluginGUI
{
    ...
    function setTabs()
    {
        ...
        if ($this->permission->checkPrivilege("accessAppointments"))
        {
            // Appointments
            $ilTabs->addTab(
                "appointments", $this->txt("appointments"), $ilCtrl->getLinkTargetByClass('ilroomsharingappointmentsgui', "showBookings")
            );
        }
        ...
        if ($this->permission->checkPrivilege("accessSearch"))
        {
            ...
            $this->tabs_gui->addTab(
                "search", $this->lng->txt("search"), $this->ctrl->getLinkTargetByClass('ilroomsharingsearchgui', "showSearchQuick")
            );
        }
        ...
        if ($this->permission->checkPrivilege("accessRooms"))
        {
            // Rooms
            $this->tabs_gui->addTab(
                "rooms", $this->txt("rooms"), $this->ctrl->getLinkTargetByClass('ilroomsharingroomsgui', "showRooms")
            );
        }
        ...
        if ($this->permission->checkPrivilege("accessFloorplans"))
        {
            // Floorplans
            $this->tabs_gui->addTab(
                "floor_plans", $this->txt("room_floor_plans"), $this->ctrl->getLinkTargetByClass("ilroomsharingfloorplansgui", "render")
            );
        }
        ...
        if ($this->permission->checkPrivilege("accessSettings"))
        {
            // Attributes for rooms and bookings
            $ilTabs->addTab(
                ATTRC::ATTRS, $this->txt("attributes"), $ilCtrl->getLinkTargetByClass(ATTRC::ATTRS_GUI, ATTRC::SHOW_ROOM_ATTR_ACTIONS)
            );
            // Settings
            $this->tabs_gui->addTab(
        ...
        if ($this->permission->checkPrivilege("accessPrivileges"))
        {
            // Privileges
            $this->tabs_gui->addTab(
                "privileges", $this->txt("privileges"), $this->ctrl->getLinkTargetByClass("ilroomsharingprivilegesgui", "showPrivileges")
            );
        }
    ...
    public function book()
    {
        ...
        $book = new ilRoomSharingBookGUI(
            $this, $_GET['room_id'], $_GET['date'] . " " . $_GET['time_from'], $_GET['date'] . " " . $_GET['time_to']
        );
