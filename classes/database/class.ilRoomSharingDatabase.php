...
class ilRoomsharingDatabase
{
    ...
    public function insertBooking($booking_attr_values, $booking_values)
    {
        ...
        $ilDB->insert(ilRoomsharingDBConstants::BOOKINGS_TABLE, array(
    ...
    {
        global $ilDB;
        $ilDB->insert(ilRoomsharingDBConstants::BOOKING_TO_ATTRIBUTE, array(
    ...
    {
        global $ilDB;
        $ilDB->insert(ilRoomsharingDBConstants::FLOORPLANS_TABLE, array(
    ...
    {
        global $ilDB;
        $ilDB->insert(ilRoomsharingDBConstants::ROOMS_TABLE, array(
    ...
    {
        global $ilDB;
        $ilDB->insert(ilRoomSharingDBConstants::ROOM_TO_ATTRIBUTE_TABLE, array(
