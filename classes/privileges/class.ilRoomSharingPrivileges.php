...
class ilRoomSharingPrivileges
{
    ...
    public function getPrivilegesMatrix()
    {
        ...
        if (ilRoomSharingNumericUtils::isPositiveNumber(count($this->getClasses())))
        {
            ...
            $privilegesMatrix[] = $this->addSelectMultipleCheckbox("bookings", array("accessAppointments", "accessSearch", "addParticipants",
            ...
            $privilegesMatrix[] = $this->addSelectMultipleCheckbox("rooms", array("accessRooms", "seeBookingsOfRooms",
            ...
            $privilegesMatrix[] = $this->addSelectMultipleCheckbox("floorplans", array("accessFloorplans",
            ...
            $privilegesMatrix[] = $this->addSelectMultipleCheckbox("privileges", array("accessSettings",
