...
class ilRoomSharingFloorPlansGUI {
     ...
     *
     * Creates an instance of RoomSharingFloorPlansTableGUI to show
     * a table with all uploaded floorplans. If logged user has 'write' 
     * permissions, a button for adding a plan is shown.
    ...
    function renderObject() {
        ...
        $table = new ilRoomSharingFloorPlansTableGUI($this, 'showFloorplans', $this->ref_id);
    ...
    /**
     * Form for addind or editing a floor plan
    ...
    function initForm($a_mode = "create", $id = NULL) {
        ...
        if ($a_mode != "edit") {
            ...
            $fplaninfo = $fplan->getFloorPlan($id, $this->pool_id);
     ...
     * 
     * This function is used to save a new Floorplan.
     */
    function saveObject() {
        global $tpl;
        ...
        if ($form->checkInput()) {
            ...
            $result = $fplan->addFloorPlan($title_new, $desc_new, $file_new, $this->pool_id);
            if ($result == 1) {
    ...
    /**
     * This function deletes a floorplan.
     * 
     * Before deleting a floorplan, the user has to confirm it.
     */
     ...
     * Editing a floorplan.
     * 
     * It is possible to edit floorplan informations (title, description, file).
     * The user has to select, if a new floorplan will be uploaded or if the
     * old one should be kept.
     * 
     * @global type $tpl
     * @global type $ilCtrl
     * @global type $tpl
    ...
    /**
     * This function saves the updated infos of a floorplan.
     * User has selected the 'save' button in edit form.
     * 
     * @global type $tpl
     */
